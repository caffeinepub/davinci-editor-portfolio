...
export class Backend implements backendInterface {
    ...
    async createVideoProject(arg0: VideoProject): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideoProject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVideoProject(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateVideoProject(arg0: bigint, arg1: VideoProject): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateVideoProject(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
